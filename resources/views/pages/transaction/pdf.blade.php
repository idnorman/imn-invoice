...
<html>
	<head>
		...
		<title>Data Transaksi PT. Instanet Media Nusantara</title>
		<style type="text/css">
		@page{
	...
	<body>
		<table class="tg">
			<thead>
				<tr>
					<th class="tg-baqh fs-16" colspan="5">PT. Instanet Media Nusantara</th>
				</tr>
			</thead>
			<tbody>
				<tr>
				...
				@if($klien != null)
				<tr>
					<td class="{{ ($layanan == null) ? 'pb-2' : '' }} bold no-border arial fs-14">Klien </td>
					<td class="{{ ($layanan == null) ? 'pb-2' : '' }} bold no-border arial fs-14" colspan="4">: {{ $klien }}</td>
				</tr>
				@endif
				@if($layanan != null)
				<tr>
